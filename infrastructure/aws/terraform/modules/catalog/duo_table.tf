...
resource "aws_glue_catalog_table" "duo_authentication_logs" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/authentication/normalized/"
...
resource "aws_glue_catalog_table" "duo_admin_logs" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/admin/normalized/"
    input_format  = "org.apache.hadoop.mapred.TextInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
...
resource "aws_glue_catalog_table" "duo_telephony_logs" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/telephony/normalized/"
    input_format  = "org.apache.hadoop.mapred.TextInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
...
resource "aws_glue_catalog_table" "duo_authentication_logs_raw" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/authentication/raw/"
    input_format  = "org.apache.hadoop.mapred.TextInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
...
resource "aws_glue_catalog_table" "duo_admin_logs_raw" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/admin/raw/"
    input_format  = "org.apache.hadoop.mapred.TextInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
...
resource "aws_glue_catalog_table" "duo_telephony_logs_raw" {
  ...
  storage_descriptor {
    location      = "s3://${var.logs_bucket_name}/duo/telephony/raw/"
    input_format  = "org.apache.hadoop.mapred.TextInputFormat"
    output_format = "org.apache.hadoop.hive.ql.io.HiveIgnoreKeyTextOutputFormat"
